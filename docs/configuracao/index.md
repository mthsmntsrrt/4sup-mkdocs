...
<p>
Na janela 'Motivo Parada', insira '0' dentro do campo 'Código' e aperte a tecla 'TAB' para inserir um novo motivo de parada. As setas servem para navegação entre os itens já cadastrados.
</p>
...
<p>
O botão 'Consultar' abre a janela Lista de Seleção Motivo Parada. Insira '0' dentro do campo 'Código' e aperte a tecla 'TAB' para inserir um novo grupo de fiscalização. As setas servem para navegação entre os itens já cadastrados.
</p>
...
<p>
Durante a criação dos itens de fiscalização, cada item é associado a um grupo previamente definido, garantindo que o checklist apresentado ao supervisor no aplicativo siga uma estrutura padronizada. O cadastro de itens será abordado no próximo item. 
</p>
...
O campo Observação/Pergunta é meramente descritivo, servindo para registrar informações adicionais que orientam o supervisor ou detalham o propósito do item. Esse campo não é exibido durante o preenchimento do checklist no aplicativo, mas pode ser consultado pela equipe gestora no portal.<br><br>
...
Clique aqui para visualizar como os itens cadastrados aparecem em uma checklist no aplicativo.<br><br>
</p>
...
<p>
Os checklist pode ser associados a um ou mais níveis hierárquicos, conforme a necessidade operacional:

Posto – o checklist será aplicado somente aos supervisores naquele posto específico;

Contrato – o checklist será aplicado a todos os supervisores de postos vinculados ao contrato;

Filial – o checklist será aplicado a todos os supervisores nos postos da filial.

Mais informações sobre "Associação de checklist" podem ser vistas aqui.
</p>
...
- :material-cog: **Habilitar o 4SUP** [:arrow_right:](habilitar.md)
- :material-table: **Tabelas de Apoio** [:arrow_right:](configuracao-posto.md)
- :material-home-city: **Configuração de Posto** [:arrow_right:](tabelas.md)
</div>
